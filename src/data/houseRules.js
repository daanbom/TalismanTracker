export const RULEBOOKS = [
  {
    name: 'Base Game',
    slug: 'base',
    subtitle: 'The journey to the Crown of Command',
    url: 'https://cdn.1j1ju.com/medias/6b/ae/41-talisman-revised-4th-edition-rulebook.pdf',
    type: 'pdf',
    group: 'core',
    icon: 'tower',
  },
  {
    name: 'The Dragon',
    slug: 'dragon',
    subtitle: 'Three dragon kings stir in the depths',
    url: 'https://cdn.1j1ju.com/medias/37/48/a6-talisman-revised-4th-edition-the-dragon-rulebook.pdf',
    type: 'pdf',
    group: 'corner',
    icon: 'dragon',
  },
  {
    name: 'The Woodland',
    slug: 'woodland',
    subtitle: 'Beasts roam the tangled wilds',
    url: 'https://cdn.1j1ju.com/medias/90/db/fc-talisman-revised-4th-edition-the-woodland-rulebook.pdf',
    type: 'pdf',
    group: 'corner',
    icon: 'tree',
  },
  {
    name: 'The City',
    slug: 'city',
    subtitle: 'Intrigue among cobbled streets',
    url: 'https://cdn.1j1ju.com/medias/f0/bc/72-talisman-the-city-rulebook.pdf',
    type: 'pdf',
    group: 'corner',
    icon: 'city',
  },
  {
    name: 'The Dungeon',
    slug: 'dungeon',
    subtitle: 'Descend into shadowed halls',
    url: 'https://cdn.1j1ju.com/medias/5b/5a/11-talisman-the-dungeon-rulebook.pdf',
    type: 'pdf',
    group: 'corner',
    icon: 'key',
  },
  {
    name: 'The Reaper',
    slug: 'reaper',
    subtitle: 'Death stalks the realm',
    url: 'https://cdn.1j1ju.com/medias/c8/40/47-talisman-the-reaper-rulebook.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'scythe',
  },
  {
    name: 'The Frostmarch',
    slug: 'frostmarch',
    subtitle: 'The land lies frozen and cursed',
    url: 'https://www.talismanisland.com/rules.htm',
    type: 'web',
    group: 'small',
    icon: 'snowflake',
  },
  {
    name: 'The Harbinger',
    slug: 'harbinger',
    subtitle: 'The end of days draws near',
    url: 'https://cdn.1j1ju.com/medias/ee/a3/67-talisman-revised-4th-edition-the-harbinger-rulebook.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'horn',
  },
  {
    name: 'The Firelands',
    slug: 'firelands',
    subtitle: 'Ash and flame from the southern peaks',
    url: 'https://cdn.1j1ju.com/medias/81/08/d9-talisman-the-firelands-rulebook.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'flame',
  },
  {
    name: 'The Cataclysm',
    slug: 'cataclysm',
    subtitle: 'The world shatters beneath your feet',
    url: 'https://cdn.1j1ju.com/medias/4d/29/9e-talisman-revised-4th-edition-the-cataclysm-rulebook.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'crack',
  },
  {
    name: 'The Sacred Pool',
    slug: 'sacred-pool',
    subtitle: 'Waters of ancient power',
    url: 'https://images-cdn.fantasyflightgames.com/ffg_content/Talisman/support/talisman-sacred-pool-rules.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'droplet',
  },
  {
    name: 'The Blood Moon',
    slug: 'blood-moon',
    subtitle: 'Night turns hunters into prey',
    url: 'https://cdn.1j1ju.com/medias/67/98/f0-talisman-revised-4th-edition-the-blood-moon-rulebook.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'moon',
  },
  {
    name: 'Lost Realms',
    slug: 'lost-realms',
    subtitle: 'Forgotten places between worlds',
    url: 'https://images-cdn.fantasyflightgames.com/filer_public/03/39/03391605-ede2-4539-bc28-d51052bd71dc/tm14-rules.pdf',
    type: 'pdf',
    group: 'small',
    icon: 'compass',
  },
